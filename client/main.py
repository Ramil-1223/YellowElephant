        ...
        match answers:
            case ChoiceList.CREATE_BASE:
                create = questionary.form(
                    cluster=questionary.select(
                        choice_cluster,
                        choices=list(ChoiceCluster),
                        style=custom_style,
                        qmark="",
                        instruction=" ",
                    ),
                    create_dbname=questionary.text(
                        input_name_base,
                        style=custom_style,
                        qmark="",
                        validate=lambda text: (
                            ...
                            else "Допустимая длина от 1 до 20"
                        ),
                    ),
                    description=questionary.text(
                        ...
                        validate=lambda text: (
                            ...
                            else "Допустимая длина от 1 до 30"
                        ),
                    ),
                ).ask()
                ...
                params = {
                    ...
                    "port": "None",
                    "cluster_id": create["cluster"],
                    "dbname": create["create_dbname"],
                }
                with Progress(
                    SpinnerColumn(),
                    ...
                    progress.add_task(
                        description="Выполняется создание базы...", total=None
                    )
            ...
            case ChoiceList.DROP_BASE_PG:
                drop = questionary.form(
                    ...
                    accept_drop=questionary.select(
                        message=accept_drop,
                        choices=list(Confirm),
                        style=custom_style,
                        qmark="",
                        instruction=" ",
                    ),
                ...
                if "accept_drop" not in drop:
                    ...
                    with Progress(
                        ...
                        progress.add_task(
                            description="Выполняется удаление базы из СУБД postgres...",
                            total=None,
                        )
            ...
            case ChoiceList.DROP_BASE_1C:
                ...
                if "accept_drop" not in drop:
                    ...
                    with Progress(
                        ...
                        progress.add_task(
                            description="Выполняется удаление базы из кластера 1С...",
                            total=None,
                        )
            ...
            case ChoiceList.BACKUP_BASE:
                backup = questionary.form(
                    backup_format=questionary.select(
                        choice_format_backup,
                        choices=list(FormatBackup),
                        style=custom_style,
                        qmark="",
                        instruction=" ",
                    ),
                    backup_dir=questionary.select(
                        choice_dir_backup,
                        choices=list(DirBackup),
                        style=custom_style,
                        qmark="",
                        instruction=" ",
                    ),
                    backup_dbname=questionary.text(
                        input_name_base,
                        style=custom_style,
                        qmark="",
                        instruction=" ",
                ...
                with Progress(
                    ...
                    progress.add_task(
                        description="Выполняется резервное копирование...", total=None
                    )
            ...
            case ChoiceList.LS_BASE:
                ...
                table.add_column(
                    f"Список баз в кластере {cluster}", header_style="#ff0000"
                )
